...
5. Then you simply have to paste the *Forwarding* url in the project env on the WEBHOOK_URL key in [docker-compose.yml](https://github.com/EpitechPromo2025/B-DEV-500-LIL-5-1-area-romain.leemans/blob/docker/docker-compose.yml "docker-compose.yml")
...
![database schema](https://imgur.com/a/ei6R7U5) 
